<ul class="well nav nav-pills">
    ...
    <li class="active"><a href="#"><i class="icon-edit"></i> Edit Rooms</a></li>
</ul>
...
<div class="add-body">
	...
	if($row != NULL) {
		$rooms_code_value = $row->room_code;
		$rooms_type_value =  $row->room_type;
		$rooms_support_floor =  $row->room_support_floor;
		$rooms_support_wall =  $row->room_support_wall;
	}
	...
	<div class="control-group">		
		<div class="controls login-button-box">
			<div class="left"><button class="btn btn-success update-rooms-button" type="submit"><i class="icon-edit"></i> Update Room</button></div>	
			<div class="clear"></div>
		</div>
	</div>
